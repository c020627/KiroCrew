...
/**
 * A save replaces a whole scope, so the pairs the panel holds when the user saves
 * ARE the new scope. That makes a stale read a lost update rather than cosmetic
 * staleness: if the controls re-enable before the post-save refetch lands, a second
 * save writes the scope as it looked BEFORE the first, silently discarding it.
 *
