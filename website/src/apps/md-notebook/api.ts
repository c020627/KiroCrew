...
export const notesApi = {
  ...
  /**
   * Update sync settings. A PARTIAL write — send only the fields being changed,
   * so two controls saving concurrently cannot overwrite each other's value.
   * `lastSync` is server-owned and is never accepted here.
   */
