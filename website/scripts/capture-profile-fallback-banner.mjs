...
const governance = fallback_profiles => ({
  version: 1,
  has_policy: true,
  profile: 'host',
  surface: 'host',
...
async function main() {
  ...
  async function shoot(name, fallback_profiles) {
    ...
    await installApiFixtures(page, {
      ...
      '/api/governance/policy': governance(fallback_profiles),
  ...
  await shoot('03-banner-names-siblings', ['cron', 'subagent'])
