...
async def create_session(
    ...
    *,
    ...
    # decision above was made BEFORE that await suspended this coroutine, and the
    # inputs to those decisions are live state that can flip inside the window.
    #
...
def read_messages(
    ...
    *,
    ...
    return {
        ...
        **({"next_since": start + len(out)} if not base else {"cursor_exact": False}),
        "messages": out,
    }
